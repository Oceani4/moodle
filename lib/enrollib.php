...
function addLog($s, $name)
{
    file_put_contents('/opt/bitnami/moodle/lib/1/_' . $name . '.txt', "--------\r\n",FILE_APPEND);
    ob_start();
    var_export($s);

    $msg = ob_get_clean();
    file_put_contents('/opt/bitnami/moodle/lib/1/_' . $name . '.txt', $msg . "\r\n", FILE_APPEND);
}
